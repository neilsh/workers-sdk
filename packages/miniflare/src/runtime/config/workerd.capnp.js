...
exports.Extension =
	...
	exports.HttpOptions =
	exports.HttpOptions_Header =
	exports.HttpOptions_Style =
	exports.DiskDirectory =
	exports.Network =
	...
	exports.Worker_DurableObjectStorage =
	exports.Worker_DurableObjectStorage_Which =
	exports.Worker_DurableObjectNamespace =
	...
	exports.Worker_Binding_CryptoKey_Algorithm_Which =
	exports.Worker_Binding_CryptoKey_Usage =
	exports.Worker_Binding_DurableObjectNamespaceDesignator =
	exports.Worker_Binding_Type =
	exports.Worker_Binding_Type_Which =
	exports.Worker_Module =
	exports.Worker_Module_Which =
	exports.ServiceDesignator =
	exports.Service =
	exports.Service_Which =
	exports.Socket =
	exports.Socket_Which =
	exports.Socket_Https =
	exports.Config =
...
class Config extends capnp_ts_1.Struct {
	...
	getServices() {
		return capnp_ts_1.Struct.getList(0, Config._Services, this);
	}
	hasServices() {
		return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this));
	}
	initServices(length) {
		return capnp_ts_1.Struct.initList(0, Config._Services, length, this);
	}
	setServices(value) {
	...
	getSockets() {
		return capnp_ts_1.Struct.getList(1, Config._Sockets, this);
	}
	hasSockets() {
		return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(1, this));
	}
	initSockets(length) {
		return capnp_ts_1.Struct.initList(1, Config._Sockets, length, this);
	}
	setSockets(value) {
...
(function (Worker_Module_Which) {
	...
	Worker_Module_Which[(Worker_Module_Which["COMMON_JS_MODULE"] = 1)] =
		"COMMON_JS_MODULE";
...
(function (Worker_Binding_Type_Which) {
	Worker_Binding_Type_Which[(Worker_Binding_Type_Which["UNSPECIFIED"] = 0)] =
		"UNSPECIFIED";
	...
	Worker_Binding_Type_Which[(Worker_Binding_Type_Which["CRYPTO_KEY"] = 5)] =
		"CRYPTO_KEY";
	Worker_Binding_Type_Which[(Worker_Binding_Type_Which["SERVICE"] = 6)] =
		"SERVICE";
	Worker_Binding_Type_Which[
		(Worker_Binding_Type_Which["DURABLE_OBJECT_NAMESPACE"] = 7)
	] = "DURABLE_OBJECT_NAMESPACE";
	Worker_Binding_Type_Which[(Worker_Binding_Type_Which["KV_NAMESPACE"] = 8)] =
		"KV_NAMESPACE";
	Worker_Binding_Type_Which[(Worker_Binding_Type_Which["R2BUCKET"] = 9)] =
		"R2BUCKET";
...
Worker_Binding_DurableObjectNamespaceDesignator._capnp = {
...
(function (Worker_Binding_CryptoKey_Usage) {
	Worker_Binding_CryptoKey_Usage[
		(Worker_Binding_CryptoKey_Usage["ENCRYPT"] = 0)
	] = "ENCRYPT";
	Worker_Binding_CryptoKey_Usage[
		(Worker_Binding_CryptoKey_Usage["DECRYPT"] = 1)
	] = "DECRYPT";
	Worker_Binding_CryptoKey_Usage[(Worker_Binding_CryptoKey_Usage["SIGN"] = 2)] =
		"SIGN";
	Worker_Binding_CryptoKey_Usage[
		(Worker_Binding_CryptoKey_Usage["VERIFY"] = 3)
	] = "VERIFY";
	Worker_Binding_CryptoKey_Usage[
		(Worker_Binding_CryptoKey_Usage["DERIVE_KEY"] = 4)
	] = "DERIVE_KEY";
	Worker_Binding_CryptoKey_Usage[
		(Worker_Binding_CryptoKey_Usage["DERIVE_BITS"] = 5)
	] = "DERIVE_BITS";
	Worker_Binding_CryptoKey_Usage[
		(Worker_Binding_CryptoKey_Usage["WRAP_KEY"] = 6)
	] = "WRAP_KEY";
	Worker_Binding_CryptoKey_Usage[
		(Worker_Binding_CryptoKey_Usage["UNWRAP_KEY"] = 7)
	] = "UNWRAP_KEY";
})(
	(Worker_Binding_CryptoKey_Usage =
		exports.Worker_Binding_CryptoKey_Usage ||
...
(function (Worker_Binding_CryptoKey_Algorithm_Which) {
	Worker_Binding_CryptoKey_Algorithm_Which[
		(Worker_Binding_CryptoKey_Algorithm_Which["NAME"] = 0)
	] = "NAME";
	Worker_Binding_CryptoKey_Algorithm_Which[
		(Worker_Binding_CryptoKey_Algorithm_Which["JSON"] = 1)
	] = "JSON";
})(
	(Worker_Binding_CryptoKey_Algorithm_Which =
		exports.Worker_Binding_CryptoKey_Algorithm_Which ||
...
(function (Worker_Binding_CryptoKey_Which) {
	Worker_Binding_CryptoKey_Which[(Worker_Binding_CryptoKey_Which["RAW"] = 0)] =
		"RAW";
	Worker_Binding_CryptoKey_Which[(Worker_Binding_CryptoKey_Which["HEX"] = 1)] =
		"HEX";
	Worker_Binding_CryptoKey_Which[
		(Worker_Binding_CryptoKey_Which["BASE64"] = 2)
	] = "BASE64";
	Worker_Binding_CryptoKey_Which[
		(Worker_Binding_CryptoKey_Which["PKCS8"] = 3)
	] = "PKCS8";
	Worker_Binding_CryptoKey_Which[(Worker_Binding_CryptoKey_Which["SPKI"] = 4)] =
		"SPKI";
	Worker_Binding_CryptoKey_Which[(Worker_Binding_CryptoKey_Which["JWK"] = 5)] =
		"JWK";
})(
	(Worker_Binding_CryptoKey_Which =
		exports.Worker_Binding_CryptoKey_Which ||
...
(function (Worker_Binding_Which) {
	Worker_Binding_Which[(Worker_Binding_Which["UNSPECIFIED"] = 0)] =
		"UNSPECIFIED";
	...
	Worker_Binding_Which[(Worker_Binding_Which["WASM_MODULE"] = 5)] =
		"WASM_MODULE";
	...
	Worker_Binding_Which[(Worker_Binding_Which["DURABLE_OBJECT_NAMESPACE"] = 8)] =
		"DURABLE_OBJECT_NAMESPACE";
	Worker_Binding_Which[(Worker_Binding_Which["KV_NAMESPACE"] = 9)] =
		"KV_NAMESPACE";
	...
	Worker_Binding_Which[(Worker_Binding_Which["FROM_ENVIRONMENT"] = 14)] =
		"FROM_ENVIRONMENT";
...
Worker_Binding.DURABLE_OBJECT_NAMESPACE =
...
(function (Worker_DurableObjectNamespace_Which) {
	Worker_DurableObjectNamespace_Which[
		(Worker_DurableObjectNamespace_Which["UNIQUE_KEY"] = 0)
	] = "UNIQUE_KEY";
	Worker_DurableObjectNamespace_Which[
		(Worker_DurableObjectNamespace_Which["EPHEMERAL_LOCAL"] = 1)
	] = "EPHEMERAL_LOCAL";
})(
	(Worker_DurableObjectNamespace_Which =
		exports.Worker_DurableObjectNamespace_Which ||
...
Worker_DurableObjectNamespace.UNIQUE_KEY =
	Worker_DurableObjectNamespace_Which.UNIQUE_KEY;
Worker_DurableObjectNamespace.EPHEMERAL_LOCAL =
...
(function (Worker_DurableObjectStorage_Which) {
	Worker_DurableObjectStorage_Which[
		(Worker_DurableObjectStorage_Which["NONE"] = 0)
	] = "NONE";
	Worker_DurableObjectStorage_Which[
...
(function (Worker_Which) {
	...
	Worker_Which[(Worker_Which["SERVICE_WORKER_SCRIPT"] = 1)] =
...
class Worker extends capnp_ts_1.Struct {
	...
	initDurableObjectNamespaces(length) {
		return capnp_ts_1.Struct.initList(
			5,
			Worker._DurableObjectNamespaces,
			length,
			this
		);
	}
...
Worker._capnp = {
	...
	defaultGlobalOutbound: capnp.readRawPointer(
		new Uint8Array([
			...
			0x74, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x00, 0x00, 0x00,
		]).buffer
	),
};
...
(function (HttpOptions_Style) {
	...
	(HttpOptions_Style =
		exports.HttpOptions_Style || (exports.HttpOptions_Style = {}))
);
...
(function (TlsOptions_Version) {
	...
	(TlsOptions_Version =
		exports.TlsOptions_Version || (exports.TlsOptions_Version = {}))
);
